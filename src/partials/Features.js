      ...
      <div className="relative max-w-6xl mx-auto px-4 sm:px-6">
        <div className="pt-12 md:pt-20">
          ...
          <div className="max-w-3xl mx-auto text-center pb-12 md:pb-16">
            <h1 className="h2 mb-4">Skills</h1>
          ...
          <div className="md:grid md:grid-cols-12 md:gap-6">
            ...
            >
              <div className="md:pr-4 lg:pr-12 xl:pr-16 mb-8">
                <h3 className="h3 mb-3">Project</h3>
                <p className="text-xl text-gray-600">1.ToDo list</p>
                <p>React JS</p>
                <p className="text-xl text-gray-600">2. </p>
                <p>React JS</p>
                <p className="text-xl text-gray-600">3. </p>
                <p>React JS</p>
                <p className="text-xl text-gray-600">4. </p>
                <p>React JS</p>
                <p className="text-xl text-gray-600">5. </p>
                <p>React JS</p>
              </div>
